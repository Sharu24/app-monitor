...
/**--------------------------------------------------------
 * Create a Server to register a User and their checks
 *
 * @protocol http
 * @params   Trimmed Url Path, Query String Object, Method,
 *           Request headers (token), Request Body Payload 
...
const server = http.createServer((req, res) => {
  ...
  req.on("end", async () => {
    try {
      ...
      let payload =
        typeof handlerResponse.message === "object"
